  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(async () => {
      try {
        ...
        setState({ report_id: job.report_id, job_id: job.id, status: job.status, progress: job.progress, stage: job.stage, report_url: job.report_url });
